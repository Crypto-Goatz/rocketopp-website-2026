  ...
  if (activeTool) {
    return (
      <div className="max-w-7xl mx-auto py-8 animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="bg-zinc-950 border border-zinc-900 rounded-3xl p-6 min-h-[600px] shadow-2xl relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto py-12 px-4 relative">
      ...
      {showGate && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md p-4 animate-[fadeIn_0.3s_ease-out]">
           <div className="max-w-md w-full bg-zinc-950 border border-zinc-800 p-8 rounded-3xl shadow-2xl relative overflow-hidden group">
            <button onClick={() => setShowGate(false)} className="absolute top-4 right-4 text-zinc-500 hover:text-white"><X className="w-6 h-6" /></button>
            <div className="absolute inset-0 bg-gradient-to-b from-orange-600/10 to-transparent pointer-events-none"></div>
            
            <div className="text-center mb-8 relative z-10">
              <div className="w-16 h-16 bg-zinc-900 rounded-full flex items-center justify-center mx-auto mb-6 border border-zinc-800 shadow-[0_0_30px_rgba(249,115,22,0.2)]">
              ...
              <div>
                <div className="relative mt-1">
                  ...
                  <input 
                    ...
                    className="w-full bg-black border border-zinc-800 rounded-xl pl-10 pr-4 py-4 text-white focus:border-orange-500 focus:outline-none transition-colors shadow-inner"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Module 1 */}
        <div className="group bg-zinc-950 border border-zinc-900 rounded-3xl p-8 hover:border-orange-500/50 transition-all duration-500 hover:shadow-[0_0_50px_rgba(249,115,22,0.1)] flex flex-col">
          <div className="w-16 h-16 bg-zinc-900 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500 shadow-inner border border-zinc-800">
            <TrendingUp className="w-8 h-8 text-orange-500" />
          </div>
          <h3 className="text-2xl font-bold text-white mb-2">Market Pulse</h3>
          <p className="text-zinc-500 mb-8 leading-relaxed flex-1">
          ...
          <div className="bg-zinc-900 rounded-xl p-4 mb-8 text-xs text-zinc-400 font-mono border border-zinc-800">
